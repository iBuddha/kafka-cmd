...
sealed trait GroupState { def state: Byte }
...
/**
  ...
  */
case object PreparingRebalance extends GroupState { val state: Byte = 1 }
...
/**
  ...
  *             group is removed by partition emigration => Dead
  */
 case object AwaitingSync extends GroupState { val state: Byte = 5}
...
/**
  ...
  *             group is removed by partition emigration => Dead
  */
case object Stable extends GroupState { val state: Byte = 3 }
...
/**
  ...
  */
case object Dead extends GroupState { val state: Byte = 4 }
...
/**
  ...
  */
case object Empty extends GroupState { val state: Byte = 5 }
...
/**
  ...
  */
@nonthreadsafe
class GroupMetadata(val groupId: String, initialState: GroupState = Empty) {
