...
case class FindPartitionOffsetResponse(request: FindPartitionOffsetRequest, offsetBehindTs: OffsetBehindTs) extends KafkaActorResponse
...
case class FindTopicOffsetResponse(request: FindTopicOffsetRequest, partitionOffset: Map[Int, OffsetBehindTs]) extends KafkaActorResponse
